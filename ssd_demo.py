...
# Dataset params
parser.add_argument("--datasets", nargs="+", default=['bgl', 'spirit', 'hdfs'], help='The dataset to be processed')
    ...
    for dataset in args.datasets:
        ...
        for window_size in session_windows:
            ...
            for tr_index, va_index in kfd.split(total_train, total_labels_train):
                ...
                print(f"total training set = {len(total_train)}, test set = {len(dataset_test)}")
                print(f"training batch = {len(dataloader_train)}, "
                      f"actual training set = {len(dataloader_train)*params['batch_size']}, "
